...
class TransformerSentenceEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        adapters: bool = False,
        adapters_dim: int = None,
        adapters_non_linearity: str = "relu",
        adapters_add_layer_norm_before: bool = True,
        adapters_add_layer_norm_after: bool = False,
        adapters_residual_before_ln: bool = True,
    ) -> None:
        ...
        if adapters:
            self.adapter = Adapter(
                self.embedding_dim,
                down_sample=adapters_dim,
                non_linearity=adapters_non_linearity,
                add_layer_norm_before=adapters_add_layer_norm_before,
                add_layer_norm_after=adapters_add_layer_norm_after,
                residual_before_ln=adapters_residual_before_ln
                )
