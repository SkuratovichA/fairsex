...
class Wav2Vec2AsrConfig(FairseqDataclass):
    ...
    adapters: bool = field(default=False, metadata={"help": "use adapters"})
    adapters_dim: int = field(default=None, metadata={"help": "adapter dimension; if None, the embedding dimension will be halved"})
    adapters_nonlinearity: str = field(default=None, metadata={"help": "adapters non-linearity relu, tanh, swish, gelu, leakyrelu"})
    adapters_add_layer_norm_before: bool = field(default=False, metadata={"help": "adapters layer norm before"})
    adapters_add_layer_norm_after: bool = field(default=False, metadata={"help": "adapters layer norm after"})
    adapters_residual_before_ln: bool = field(default=False, metadata={"help": "adapters residual before LayerNorm"})
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2AsrConfig, output_size=None):
        ...
        self.adapters = cfg.adapters
        self.adapters_dim=cfg.adapters_dim
        self.adapters_non_linearity=cfg.adapters_non_linearity
        self.adapters_add_layer_norm_before=cfg.adapters_add_layer_norm_before
        self.adapters_add_layer_norm_after=cfg.adapters_add_layer_norm_after
        self.adapters_residual_before_ln=cfg.adapters_residual_before_ln
            ...
            for name, module in model.named_modules():
                if "encoder.layers" in name and len(name.split(".")) == 3:
                    ...
                    with module.summon_full_params():
                        module.load_state_dict(new_dict, strict=True and not self.adapters)
