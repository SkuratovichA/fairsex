...
class Wav2Vec2AsrConfig(FairseqDataclass):
    ...
    adapters_dim: Optional[int] = field(default=None, metadata={"help": "adapter dimension; if None, the embedding dimension will be halved"})
    adapters_non_linearity: Optional[str] = field(default=None, metadata={"help": "adapters non-linearity relu, tanh, swish, gelu, leakyrelu"})
